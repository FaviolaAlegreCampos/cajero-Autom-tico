...
public class CrearCuentaPrincipal extends javax.swing.JFrame {
    ...
    private void AceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AceptarMouseClicked
        ...
        Mensaje.setText("");
        Mensaje1.setText("");
        String Direccion = "C:\\Archivos gestor\\Archivos gestor\\Cuentas\\" + String.valueOf(a.ObtenerUltimoId()+1);
        if(nombre.getText().isEmpty() || apellido.getText().isEmpty() || ci.getText().isEmpty()){
         Mensaje.setText(I.leerFila(20,direccion));
        }else{           
           if(a.Control("C:\\Archivos gestor\\Archivos gestor\\Usuarios\\usuarios.txt",ci.getText(),2)){
